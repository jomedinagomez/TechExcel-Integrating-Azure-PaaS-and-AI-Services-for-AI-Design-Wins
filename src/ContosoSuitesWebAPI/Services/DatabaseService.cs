...
public class DatabaseService : IDatabaseService
{
    ...
    [KernelFunction]
    [Description("Get all bookings for a single hotel and a minimum stay begin date..")]
    ...
    [KernelFunction]
    [Description("Get all bookings that do not have corresponding entries in the database.")]
    ...
    [KernelFunction]
    [Description("Get all bookings that have more than one associated hotel room in the database.")]
